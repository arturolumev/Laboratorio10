...
@section('content')
    ...
    <div class="bloc mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200
rounded-lg shadow-lg">
        ...
        w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Name"
                   id="name" name="name">
        ...
        w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Email"
                   id="email" name="email">
        ...
        text-white fomt-semibold p-2 my-3 hover:bg-green-600">Send</button>
